<div class="row">
  <div class="columns">
    <h2 class="prettytitle wow fadeInRight">
      <?php _e('Send us a <span>message!</span>','haris') ?>
      <?php _e('<small>We’ll definitely reply</small>','haris') ?>
    </h2>
  </div>
</div>
      ...
      <div class="row">
        <div class="columns">
          <label for="message_text">
            ...
            <small class="form-error"><?php _e('Required field', 'haris') ?></small>
          </label>
        </div>
      </div>
...
<!--       <div data-abide-error class="alert callout" style="display: none;">
      ...
      <div class="row formactions">
        <fieldset class="small-6 columns">
          <button id="contact_reset" type="reset" class="button success hollow">
            <?php _e('Clear', 'haris') ?>
          </button>
        </fieldset>
        <fieldset class="small-6 columns text-right">
          <button id="contact_submit" type="submit" class="button success hollow">
            <?php _e('Send', 'haris') ?>
          </button>
        </fieldset>
      </div>
